(function () {
  ...
  const PRODUCT_DEFAULTS = [
    ...
    { id: 9, name: 'Titanium Aviator 42mm', brand: 'AURUM', category: 'Men', price: 34500, oldPrice: 39900, movement: 'Automatic', glass: 'Domed Sapphire', water: '100M', strap: 'Stainless Steel', case: 'silver', tag: 'Best Seller', image: px(2774158), description: 'A pilot\'s watch engineered in lightweight grade-5 titanium with a matte sandblasted finish. Swiss automatic movement, anti-reflective domed sapphire, and a 100M rating — built for the skies and the boardroom alike.' },
    { id: 10, name: 'Executive Chronograph Gold', brand: 'AURUM', category: 'Men', price: 42000, oldPrice: null, movement: 'Automatic', glass: 'Sapphire', water: '50M', strap: 'Alligator Leather', case: 'gold', tag: 'Limited', image: px(190819), description: 'The pinnacle of executive presence — 18K gold-plated case with a deep navy dial and three sub-dials. Column-wheel chronograph movement, sapphire crystal, and hand-stitched alligator strap. Limited to 200 pieces.' },
    { id: 11, name: 'Field Officer Automatic', brand: 'AURUM', category: 'Men', price: 22800, oldPrice: 26500, movement: 'Automatic', glass: 'Sapphire', water: '100M', strap: 'Canvas', case: 'black', tag: null, image: px(267394), description: 'Military-inspired ruggedness meets refined watchmaking. Matte black ceramic-coated case, high-contrast Arabic numerals, 100M water resistance, and a durable canvas NATO strap — ready for any mission.' },
    { id: 12, name: 'Grand Tourer Dual Time', brand: 'AURUM', category: 'Men', price: 38500, oldPrice: null, movement: 'Automatic', glass: 'Domed Sapphire', water: '100M', strap: 'Italian Leather', case: 'rose', tag: 'New Arrival', image: px(2451965), description: 'For the modern globetrotter — dual-time GMT complication with independent hour hand, rose-gold case, sunburst brown dial, and a supple Italian leather strap. Elegance that crosses time zones.' },

    { id: 13, name: 'Junior Explorer 28mm', brand: 'AURUM KIDS', category: 'Kids', price: 4500, oldPrice: 5500, movement: 'Quartz', glass: 'Mineral', water: '50M', strap: 'Silicone', case: 'silver', tag: 'Best Seller', image: px(1016895), description: 'Designed for young adventurers — 28mm lightweight case, shock-resistant quartz movement, 50M water resistance, and a soft hypoallergenic silicone strap in playful colors. Easy-read dial with luminous hands.' },
    { id: 14, name: 'Little Navigator 30mm', brand: 'AURUM KIDS', category: 'Kids', price: 5200, oldPrice: null, movement: 'Quartz', glass: 'Mineral', water: '30M', strap: 'Leather', case: 'navy', tag: 'Gift Pick', image: px(1697758), description: 'A first "real" watch for growing minds. Navy sunburst dial with applied indices, Japanese quartz precision, genuine leather strap, and 30M splash resistance — teaches time-telling with style.' },
    { id: 15, name: 'Tiny Treasures Rose Gold', brand: 'AURUM KIDS', category: 'Kids', price: 3800, oldPrice: 4500, movement: 'Quartz', glass: 'Mineral', water: '30M', strap: 'Silicone', case: 'rose', tag: null, image: px(416839), description: 'Sweet rose-gold tone case with a pearlescent dial and butterfly clasp silicone strap. Lightweight, water-resistant to 30M, and perfectly sized for small wrists — a cherished keepsake gift.' },
    { id: 16, name: 'Sporty Kid Chrono 32mm', brand: 'AURUM KIDS', category: 'Kids', price: 6100, oldPrice: 7200, movement: 'Quartz', glass: 'Mineral', water: '50M', strap: 'Silicone', case: 'black', tag: 'New Arrival', image: px(1136856), description: 'Kid-friendly chronograph with three sub-dials, stopwatch function, and bold Arabic numerals. Durable silicone strap, 50M water resistance, and shock-absorbing case — built for playground champions.' },

    { id: 17, name: 'AURUM Smart Core', brand: 'AURUM', category: 'Smartwatch', price: 18900, oldPrice: 22000, movement: 'Smart Quartz', glass: 'Sapphire', water: '50M', strap: 'Fluoroelastomer', case: 'silver', tag: 'Best Seller', image: px(437037), description: 'Your wrist companion reimagined — 1.43" AMOLED display, heart-rate & SpO2 monitoring, sleep tracking, GPS, 7-day battery, and Bluetooth calling. Sapphire glass, aluminum case, and interchangeable fluoroelastomer strap.' },
    { id: 18, name: 'AURUM Smart Elite', brand: 'AURUM', category: 'Smartwatch', price: 28500, oldPrice: null, movement: 'Smart Hybrid', glass: 'Sapphire', water: '100M', strap: 'Titanium', case: 'black', tag: 'Limited', image: px(2774159), description: 'Premium hybrid smartwatch — mechanical hands overlay a hidden OLED display. Titanium case, sapphire crystal, 100M water resistance, ECG sensor, blood oxygen, 14-day battery, and a woven titanium bracelet. Limited edition.' },
    { id: 19, name: 'AURUM Active Fit', brand: 'AURUM', category: 'Smartwatch', price: 12900, oldPrice: 15500, movement: 'Smart Quartz', glass: 'Gorilla Glass', water: '50M', strap: 'Silicone', case: 'navy', tag: 'New Arrival', image: px(1004058), description: 'Fitness-focused smartwatch with 1.32" always-on display, 100+ sport modes, VO2 max, stress tracking, and 10-day battery. Lightweight polymer case, Gorilla Glass, and breathable silicone sport band — your daily coach.' },
    { id: 20, name: 'AURUM Smart Classic', brand: 'AURUM', category: 'Smartwatch', price: 22000, oldPrice: 25000, movement: 'Smart Hybrid', glass: 'Sapphire', water: '50M', strap: 'Leather', case: 'gold', tag: null, image: px(267395), description: 'Timeless analog aesthetics meet modern intelligence — genuine leather strap, gold-tone stainless steel case, sapphire glass, and a discreet e-ink sub-dial for notifications, activity rings, and 30-day battery life. Classic outside, smart inside.' },

    { id: 21, name: 'AURUM Wear OS Pro', brand: 'AURUM', category: 'Smartwatch', price: 32000, oldPrice: 36500, movement: 'Wear OS 4', glass: 'Sapphire', water: '50M', strap: 'Fluoroelastomer', case: 'silver', tag: 'Best Seller', image: px(437038), description: 'Powered by Wear OS 4 — Snapdragon W5+ Gen 1, 1.43" AMOLED, 2GB RAM/32GB storage, GPS, NFC for Google Wallet, rotating crown, 24hr+ battery with fast charging. Sapphire crystal, aluminum case, Play Store access.' },
    { id: 22, name: 'AURUM Pixel Watch 2', brand: 'AURUM', category: 'Smartwatch', price: 29900, oldPrice: null, movement: 'Wear OS 4', glass: 'Gorilla Glass 5', water: '50M', strap: 'Sport Band', case: 'black', tag: 'Limited', image: px(1004059), description: 'Google-designed Wear OS experience — Fitbit health suite, ECG, blood oxygen, stress management, safety check, 24hr battery with fast charge. Recycled aluminum, domed glass, seamless band integration.' },
    { id: 23, name: 'AURUM Galaxy Watch 6', brand: 'AURUM', category: 'Smartwatch', price: 27500, oldPrice: 31000, movement: 'Wear OS 4', glass: 'Sapphire', water: '50M', strap: 'Hybrid Leather', case: 'silver', tag: 'Hot', image: px(2774160), description: 'Samsung Wear OS flagship — BioActive sensor (HR, ECG, BIA), advanced sleep coaching, body composition, rotating bezel, 40hr battery. Premium sapphire, One UI Watch, Google services built-in.' },
    { id: 24, name: 'AURUM TicWatch Pro 5', brand: 'AURUM', category: 'Smartwatch', price: 25900, oldPrice: null, movement: 'Wear OS 3.5', glass: 'Gorilla Glass', water: '50M', strap: 'Silicone', case: 'black', tag: 'New Arrival', image: px(1136857), description: 'Mobvoi dual-display tech — ultra-low-power FSTN + AMOLED for 80hr battery. Snapdragon W5+ Gen 1, dual-frequency GPS, 100+ workouts, voice assistant, MIL-STD-810H durability. Wear OS 3.5 upgradable.' },
    { id: 25, name: 'AURUM OnePlus Watch 2', brand: 'AURUM', category: 'Smartwatch', price: 23900, oldPrice: 27000, movement: 'Wear OS 4', glass: 'Sapphire', water: '50M', strap: 'Fluoroelastomer', case: 'navy', tag: null, image: px(1697759), description: 'Dual-engine architecture — Snapdragon W5 + BES2700 MCU for 100hr smart mode. 1.43" AMOLED, dual-frequency GPS, 100+ sports, VO2 max, stainless steel bezel, 76hr battery. Fast charge 10min = 1 day.' },
    { id: 26, name: 'AURUM Fossil Gen 6', brand: 'AURUM', category: 'Smartwatch', price: 21500, oldPrice: 24500, movement: 'Wear OS 3', glass: 'Mineral', water: '30M', strap: 'Stainless Steel', case: 'gold', tag: null, image: px(190820), description: 'Classic Fossil design meets Wear OS — Snapdragon 4100+, 1.28" AMOLED, 1GB RAM/8GB storage, SpO2, HR, GPS, NFC payments, rapid charging (80% in 30min). Interchangeable 22mm straps.' },
    { id: 27, name: 'AURUM Montblanc Summit 3', brand: 'AURUM', category: 'Smartwatch', price: 48500, oldPrice: null, movement: 'Wear OS 3', glass: 'Sapphire', water: '50M', strap: 'Calfskin Leather', case: 'rose', tag: 'Limited', image: px(2451966), description: 'Luxury Swiss-made Wear OS — Titanium case, sapphire dome, Snapdragon 4100+, 1.28" AMOLED, 1GB/8GB, Montblanc watch faces, 24hr battery, quick charge. Italian calfskin strap, 100m diving bezel option.' },
    { id: 28, name: 'AURUM Skagen Falster Gen 6', brand: 'AURUM', category: 'Smartwatch', price: 19900, oldPrice: 22500, movement: 'Wear OS 3', glass: 'Mineral', water: '30M', strap: 'Mesh Steel', case: 'silver', tag: null, image: px(33684304), description: 'Danish minimalist Wear OS — 42mm ultra-thin case, Snapdragon 4100+, 1.28" AMOLED, SpO2, HR, GPS, NFC, 24hr+ battery. Mesh bracelet with quick-release, 20mm straps, Always-On display.' }
  ];
